"""CLI for SLLM shell-client control."""
...
from sllm.controller import ShellDriveRequest, drive_shell_llm, result_from_error
from sllm.nlp import intent_from_text
from sllm.registry import detect_clients
from sllm.validation import ecosystem_status, validate_intent
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="sllm")
    ...
    nlp = sub.add_parser("nlp", help="Map natural language to SLLM drive DSL.")
    ...
    validate = sub.add_parser("validate", help="Validate SLLM ecosystem hooks.")
